...
def main():
    ...
    print(" Hybrid Orchestrator installed successfully!")
...
def _index_codebase(root: Path) -> None:
    ...
    try:
        ...
        print(" Openground indexing failed. Semantic search will fallback to regex.")
...
def _install_openground() -> None:
    ...
    try:
        ...
        print(" Openground installation failed. Falling back to regex scanning.")
...
def _install_codesum() -> None:
    ...
    print(f" codesum installed to: {bin_dir}")
...
def _add_to_user_path() -> None:
    ...
    try:
        ...
        print(f" Failed to modify PATH: {e}. Manual PATH addition may be required.")
